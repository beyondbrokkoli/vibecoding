...
return function(
    ...
    function Bubble.Tick(dt, current_time)
        local id = my_obj_start
        ...
        -- THE WOBBLE MATH (Patrick Star effect)
        local eversion = 1.0 -- Never turn inside out
        local bulge = math_sin(current_time * 3.0) * 0.75 -- The wobble scale

        -- Call the Paradox kernel, but it won't evert!
    ...
    function Bubble.Raster(CANVAS_W, CANVAS_H, ScreenPtr, ZBuffer)
