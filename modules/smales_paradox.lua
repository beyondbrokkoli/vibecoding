...
return function(
    ...
    local TCOUNT = LATITUDES * LONGITUDES * 4 -- Double faces!
    ...
    function Paradox.Init()
        ...
        local tIdx = tStart
        -- ABGR Colors honoring the 1994 Geometry Center video
        local col_gold = bit.bor(0xFF000000, bit.lshift(0, 16), bit.lshift(170, 8), 255)
        local col_purple = bit.bor(0xFF000000, bit.lshift(255, 16), bit.lshift(0, 8), 170)
        ...
        for i = 0, LATITUDES - 1 do
            for j = 0, LONGITUDES - 1 do
                ...
                -- OUTSIDE FACES (Gold, CCW Winding)
                ...
                -- INSIDE FACES (Purple, CW Winding)
                Tri_V1[tIdx], Tri_V2[tIdx], Tri_V3[tIdx] = a, c, d; Tri_BakedColor[tIdx] = col_purple; tIdx = tIdx + 1
                Tri_V1[tIdx], Tri_V2[tIdx], Tri_V3[tIdx] = a, b, c; Tri_BakedColor[tIdx] = col_purple; tIdx = tIdx + 1
            end
        end
    end
